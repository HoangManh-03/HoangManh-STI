...
#define USING_MAIN_BOARD
    ...
    {
        MAIN_ID                 = 0x00,
        MAIN_rec_analogVoltage0 = 0x01,
        MAIN_rec_analogVoltage1 = 0x02,
        MAIN_rec_analogCurrent0 = 0x03,
        MAIN_rec_analogCurrent1 = 0x04,
        MAIN_rec_stsButton_reset= 0x05,
        MAIN_rec_stsButton_power= 0x06,
        MAIN_rec_EMG_status     = 0x07,
