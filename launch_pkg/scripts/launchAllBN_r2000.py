...
class scanMap():
    def __init__(self):
        ...
        self.path_nuc = rospy.get_param('path_nuc', '')
        ...
        # -- module - lidar peperl r2000
        self.path_r2000 = rospy.get_param('path_r2000', '')
        self.launch_r2000 = Launch(self.path_r2000)
        rospy.Subscriber('/scan', LaserScan, self.callBack_r2000)
        self.is_r2000 = 0
        self.count_node += 1

        # -- module - lidar peperl r2000 navigation
        self.path_r2000_navigation = rospy.get_param('path_r2000_navigation', '')
        self.launch_r2000_navigation = Launch(self.path_r2000_navigation)
        rospy.Subscriber('/r2000_reflectors', R2000_reflectors, self.callBack_r2000_reflectors)
        self.is_r2000ref = 0
        self.count_node += 1
        ...
        # -- module - ps3.
        self.path_ps3 = rospy.get_param('path_ps3', '')
        self.launch_ps3 = Launch(self.path_ps3)
        self.is_ps3 = 0
        self.count_node += 1
    ...
    def callBack_r2000(self, data):
        self.is_r2000 = 1

    def callBack_r2000_reflectors(self, data):
        self.is_r2000ref = 1
    ...
    def run(self):
        while not rospy.is_shutdown():
            ...
            # -- nuc_info
                ...
                self.notification = 'launch_nuc_info'
            ...
            # -- Convert CAN ROS
                ...
                sts = self.launch_convertCAN.start_and_wait(4.)
                if (sts == 1):
                    self.step += 1
                    self.step = 11
                    time.sleep(self.timeWait)

            # -- nav350 -- skip temporary -- 
            # elif (self.step == 10):
            ...
            # -- r2000 pepperl lidar
            # elif (self.step == 10):
            #     self.notification = 'launch_r2000'
            #     self.launch_r2000.start()
            #     if (self.is_r2000 == 1):
            #         self.step += 1
            #         time.sleep(self.timeWait)
            ...
            # -- r2000 navigation
                ...
                self.notification = 'launch_r2000_navigation'
                self.launch_r2000_navigation.start()
                if (self.is_r2000ref == 1):
                    self.step += 1
                    time.sleep(self.timeWait)
            ...
            # -- safety zone Nav350 - skip temporary
            elif (self.step == 15):
            ...
            # # -- posePublisher
                ...
                self.notification = 'launch_ps3'
                sts = self.launch_ps3.start_and_wait(3.)
                if (sts == 1):
                    self.step = 21
                    time.sleep(self.timeWait)
