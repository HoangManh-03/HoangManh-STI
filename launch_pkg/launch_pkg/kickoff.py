...
class RobotBringUp(LifecycleNode):
    def __init__(self):
        ...
        self.sub_rfid_front = self.create_subscription(
            RFID,
            'rfid_front_respond',
            self.callBack_rfid_front,
            10)
        self.sub_rfid_front
        self.is_rfid_front = 0

        self.sub_rfid_behind = self.create_subscription(
            RFID,
            'rfid_behind_respond',
            self.callBack_rfid_behind,
            10)
        self.sub_rfid_behind
        self.is_rfid_behind = 0
    ...
    def callBack_rfid_front(self, data):
        self.is_rfid_front = 1

    def callBack_rfid_behind(self, data):
        self.is_rfid_behind = 1
    ...
    def run(self):
        ...
        if (self.step == 0):
            ...
            if self.is_rfid_front and self.is_magline_behind:
                self.step += 1
                time.sleep(self.timeWait)
