    ...
    def run(self):
        while not rospy.is_shutdown():
            ...
            # vẽ lộ trình từ NN_cmdRequest
                ...
                if self.data_NN.target_x == 0.991 and self.data_NN.target_y == 5.771:
                    if self.data_NNinfo.task_status == 66 and self.data_NNinfo.process == 8:
                        # if self.is_first_getpose == True:
                ...
                if self.data_NN.target_x == 0.669 and self.data_NN.target_y == 0.184:
                    if self.data_NNinfo.task_status == 66 and self.data_NNinfo.process == 8:
            ...
            # - vẽ đồ thị lộ trình
                ...
                print("List các điểm vị trí point 5 cuả AGV là:", len(self.ls_pose_exec_point5))
                print("List các điểm vị trí point 6 cuả AGV là:", len(self.ls_pose_exec_point6))
                ...
                pointx2, pointy2 = zip(*self.ls_pose_exec_point5)
                ...
                pointx3, pointy3 = zip(*self.ls_pose_exec_point6)
