...
class Navigation_mode():
    def __init__(self):
        ...
        self.ANGLE_THRESHOLD_INCREMENT = 0.
        ...
        self.RMSE_THRESHOLD_INITMODE = 0.1              # before: 0.1
                    ...
                    for item_theta_new in list_IDref_satify_fromtheta:
                        ...
                        for item_d in list_IDref_satify_fromd:
                            ...
                            if id0_theta_ref == id0_dis_ref and id1_theta_ref == id1_dis_ref:
                                ...
                                # # subcase 2: tồn tại 12 và 21  => hình như ko có case này
                                ...
                                # subcase 4: tồn tại 14 và 41  => hình như ko có case này
