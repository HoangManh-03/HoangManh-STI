                ...
                if self.process == 1:           # quy trinh 1
                    if self.subprocess == 1:  # -- nâng kệ ở 2 => hạ kệ ở 1
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.target_x = 3.696
                            self.data_NNcmdRequest.target_y = 1.031
                            self.data_NNcmdRequest.target_z = 1.5448
                            self.data_NNcmdRequest.tag = 0
                            self.data_NNcmdRequest.offset = 1.2
                            self.data_NNcmdRequest.list_id = [3, 4, 0, 0, 0]
                            self.data_NNcmdRequest.list_x = [-1.224, 3.696, 0, 0, 0]
                            self.data_NNcmdRequest.list_y = [1.804, 1.031, 0, 0, 0]
                        ...
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.list_x = [3.696, 0, 0, 0, 0]
                            self.data_NNcmdRequest.list_y = [1.031, 0, 0, 0, 0]
                        ...
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.target_x = -1.224
                            self.data_NNcmdRequest.target_y = 1.804
                            self.data_NNcmdRequest.target_z = -1.57341
                            self.data_NNcmdRequest.tag = 0
                            self.data_NNcmdRequest.offset = 1.2
                            self.data_NNcmdRequest.list_id = [4, 3, 0, 0, 0]
                            self.data_NNcmdRequest.list_x = [3.696, -1.224, 0, 0, 0]
                            self.data_NNcmdRequest.list_y = [1.031, 1.804, 0, 0, 0]
                            self.data_NNcmdRequest.list_speed = [100, 100, 0, 0, 0]
                            self.data_NNcmdRequest.before_mission = self.serverMission_liftUp
                            self.data_NNcmdRequest.after_mission = self.serverMission_liftDown
                            self.data_NNcmdRequest.id_command = 0
                        ...
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.list_x = [-1.224, 0, 0, 0, 0]
                            self.data_NNcmdRequest.list_y = [1.804, 0, 0, 0, 0]
                            self.data_NNcmdRequest.list_speed = [100, 0, 0, 0, 0]
                            self.data_NNcmdRequest.before_mission = self.serverMission_liftDown
                            self.data_NNcmdRequest.after_mission = self.serverMission_liftUp
                            self.data_NNcmdRequest.id_command = 0
