                ...
                if self.process == 1:           # quy trinh 1
                    if self.subprocess == 1:  # -- nâng kệ ở 2 => hạ kệ ở 1
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.target_x = -0.813
                            self.data_NNcmdRequest.target_y = -1.416
                            self.data_NNcmdRequest.target_z = 3.129200816
                            self.data_NNcmdRequest.tag = 0
                            self.data_NNcmdRequest.offset = 1.2
                            self.data_NNcmdRequest.list_id = [1, 2, 3, 4, 0]
                            self.data_NNcmdRequest.list_x = [-0.736, -0.832, -0.828, -0.813, 0]
                            self.data_NNcmdRequest.list_y = [-7.257, -5.048, -3.119, -1.416, 0]
                        ...
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.tag = 0
                            self.data_NNcmdRequest.offset = 1.2
                            self.data_NNcmdRequest.list_id = [4, 0, 0, 0, 0]
                            self.data_NNcmdRequest.list_x = [-0.813, 0, 0, 0, 0]
                            self.data_NNcmdRequest.list_y = [-1.416, 0, 0, 0, 0]
                        ...
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.target_x = -0.736
                            self.data_NNcmdRequest.target_y = -7.257
                            self.data_NNcmdRequest.target_z = -0.000872665
                            self.data_NNcmdRequest.tag = 0
                            self.data_NNcmdRequest.offset = 1.2
                            self.data_NNcmdRequest.list_id = [4, 3, 2, 1, 0]
                            self.data_NNcmdRequest.list_x = [-0.813, -0.828, -0.832, -0.736, 0]
                            self.data_NNcmdRequest.list_y = [-1.416, -3.119, -5.048, -7.257, 0]
                            self.data_NNcmdRequest.list_speed = [100, 100, 100, 100, 0]
                            self.data_NNcmdRequest.before_mission = self.serverMission_liftUp
                            self.data_NNcmdRequest.after_mission = self.serverMission_liftDown
                            self.data_NNcmdRequest.id_command = 0
                        ...
                        if time.time() - self.DieTime_pub < 3:                   
                            ...
                            self.data_NNcmdRequest.list_x = [-0.736, 0, 0, 0, 0]
                            self.data_NNcmdRequest.list_y = [-7.257, 0, 0, 0, 0]
                            self.data_NNcmdRequest.list_speed = [100, 0, 0, 0, 0]
                            self.data_NNcmdRequest.before_mission = self.serverMission_liftDown
                            self.data_NNcmdRequest.after_mission = self.serverMission_liftUp
                            self.data_NNcmdRequest.id_command = 0
