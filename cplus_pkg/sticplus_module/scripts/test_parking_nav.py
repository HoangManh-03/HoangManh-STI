...
class ParkingNAV(threading.Thread):
    ...
    def pub_Status(self, stt, modeRun, pose, offset, ss_x, ss_y, ss_a, meaning):
        ...
        while not self.shutdown_flag.is_set():
            ...
            if self.process == 0:
                ...
                if self.is_request_parking == True:
                    if self.req_parking.modeRun == 1: #Run
            ...
            self.pub_Status(self.process, self.req_parking.modeRun, self.req_parking.poseTarget, self.req_parking.offset, self.ss_x, self.ss_y, self.ss_a, self.Meaning(self.process))
...
def main():
    ...
    try:
        ...
        while not rospy.is_shutdown():
            if j1.pubTransform == True and j1.req_parking.modeRun == 1:
