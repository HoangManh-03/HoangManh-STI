...
class quyTrinh(threading.Thread):
    ...
    def run(self):
       ...
       #goal2_vao
        ...
        goal2_vao.target_pose.pose.position.x    = 0.720
        goal2_vao.target_pose.pose.position.y    = 0.056
        goal2_vao.target_pose.pose.orientation.z = 0.022
        goal2_vao.target_pose.pose.orientation.w = 1.000
        # goal2_vao.target_pose.header.frame_id    = "map"
        # goal2_vao.target_pose.pose.position.x    = 0.167
        # goal2_vao.target_pose.pose.position.y    = -0.040
        # goal2_vao.target_pose.pose.orientation.z = -0.010
        # goal2_vao.target_pose.pose.orientation.w = 1.000
       #goal2_bt
       ...
       #goal2_q
        ...
        goal2_q.target_pose.pose.position.x    = 0.167
        goal2_q.target_pose.pose.position.y    = -0.040
       ...
       #goal4_vao
        ...
        goal4_vao.target_pose.pose.position.x    = -11.730
        goal4_vao.target_pose.pose.position.y    = 1.824
        goal4_vao.target_pose.pose.orientation.z = 0.723
        goal4_vao.target_pose.pose.orientation.w = 0.690
       #goal4_bt
       ...
       #goal4_q
        ...
        goal4_q.target_pose.pose.position.x    = -11.696
        goal4_q.target_pose.pose.position.y    = 1.447
        goal4_q.target_pose.pose.orientation.z = -0.731
        goal4_q.target_pose.pose.orientation.w = 0.683

       #p1_th
        # p1_th.target_pose.header.frame_id    = "map"
        # p1_th.target_pose.pose.position.x    = 0.058
        # p1_th.target_pose.pose.position.y    = -3.028
        # p1_th.target_pose.pose.orientation.z = 0.699
        # p1_th.target_pose.pose.orientation.w = 0.715
        p1_th.target_pose.header.frame_id    = "map"
       ...
       #p2_th
        ...
        p2_th.target_pose.pose.position.x    = -11.566
        p2_th.target_pose.pose.position.y    = -0.800
        p2_th.target_pose.pose.orientation.z = 0.725
        p2_th.target_pose.pose.orientation.w = 0.689
       #p2_ng
        p2_ng.target_pose.header.frame_id    = "map"
        p2_ng.target_pose.pose.position.x    = -11.792
        p2_ng.target_pose.pose.position.y    = -0.669
        p2_ng.target_pose.pose.orientation.z = -0.010
        p1_ng.target_pose.pose.orientation.w = 1.000
       ...
       #
        ...
        while not self.shutdown_flag.is_set():
            ...
            if dem == 1 :
                ...
                time.sleep(0.5)
                self.client.wait_for_result()
                if self.client.get_state() == GoalStatus.SUCCEEDED : dem =  8
                else: 
                    dem =  5
                    print " error 4"
                ...
                time.sleep(0.5)
                self.client.wait_for_result()
                if self.client.get_state() == GoalStatus.SUCCEEDED : dem = 80
                else: 
                    dem = 8
                    print " error 4 "
                ...
                time.sleep(0.5)
                self.client.wait_for_result()
                if self.client.get_state() == GoalStatus.SUCCEEDED : dem = 1 #13
                else: 
                    dem = 12
                    print " error 4"
                ...
                time.sleep(0.5)
                self.client.wait_for_result()
                if self.client.get_state() == GoalStatus.SUCCEEDED : dem = 14
                else: 
                    dem = 13
                    print " error 4 "
