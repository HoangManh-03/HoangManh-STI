...
class AutomaticParkingVision():
    ...
    def cbGetMarkerOdom(self, markers_odom_msg):
        # print "hahaaa"
        for marker_odom_msg in markers_odom_msg.detections:
            # print "a a a"
            # if marker_odom_msg.detections.at(0).id == 4:
                # print "hihi"
    ...
    def fnGet2DMarkerPose(self, marker_odom_msg):
        ...
        pos_x = marker_odom_msg.pose.pose.pose.position.z
        pos_y = -marker_odom_msg.pose.pose.pose.position.x
