#!/usr/bin/env python
# Author : AnhTuan 29/10/2020
# parking ket hop line tu 
# update : 2/11/2020
import rospy
import numpy as np
import tf
...
from sti_msgs.msg import Parking_control , Parking_status, Main_status
import math
import time
import threading
import signal
        ...
        while not self.shutdown_flag.is_set():
          ...
          # B111: check line tu 
            if buoc == 111 : 
                ...
                if self.Line_ahead > 1. and self.Line_ahead < 16. :
            ...
            if buoc == 3 :
                ...
                if(goc_taget > 0):
                    ...
                    if math.fabs(self.odom_g - goc_taget) > 0.04 :
                        ...
                        if twist.angular.z < 0.15 and twist.angular.z > 0 : twist.angular.z = 0.15                                                   
...
def main():
    ...
    rospy.init_node('parking_lintu_v1')
