...
class WelcomeScreen(QDialog):
	def __init__(self):
		...
		loadUi("/home/stivietnam/catkin_ws/src/app_ros/interface/app_vs3.ui", self)
		# --
		...
		self.password_data = ""
		# -- 
		# self.cb_listError.addItem("Bi Cham Blsock")
		# self.cb_listError.addItem('Cam Bien NAV')
		# self.cb_listError.addItem('LoadCell-Dau noi')
		# self.cb_listError.addItem('Khong Phat Hien Guong')
		# self.cb_listError.addItem('Mat Driver2')
		self.cb_listError.setStyleSheet("color: red;")
		self.cb_listWarn.setStyleSheet("color: orange;")
	...
	def set_labelValue(self, data_blv): # App_lbv()
		...
		self.cb_listError.clear()
		self.cb_listWarn.clear()

		self.cb_listError.addItems(data_blv.cb_listError)
		self.cb_listWarn.addItems(data_blv.cb_listWarn)	
