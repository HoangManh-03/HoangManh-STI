...
"""
from app_ros.app_interface import * 
...
class Program(Node):
	...
	def controlColor(self):
		...
		# --
		self.statusColor.lbc_limit_up = self.lift_status.sensorUp
		self.statusColor.lbc_limit_down = self.lift_status.sensorDown
		self.statusColor.lbc_detect_lifter = self.lift_status.sensorLift.data
	...
	def controlAll(self):
		...
		# -- 
		self.valueLable.lbv_rfid_lastcode = str(self.NN_infoRespond.RFID_lastCode)
