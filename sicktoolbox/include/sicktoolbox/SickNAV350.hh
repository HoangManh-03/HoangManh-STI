...
class SickNav350 : public SickLIDAR< SickNav350BufferMonitor, SickNav350Message > {
  ...
  public:
    ...
    static const std::string SetDataGet_COMMAND_TYPE;
    static const std::string SetDataGet_COMMAND;
    ...
    // -- add new
    static const std::string SHOWOPT_COMMAND_TYPE;
    static const std::string SHOWOPT_COMMAND;

    static const std::string SETREFTHRESHOLD_COMMAND_TYPE;
    static const std::string SETREFTHRESHOLD_COMMAND;

    static const std::string LandmarkDataFormat_COMMAND_TYPE;
    static const std::string LandmarkDataFormat_COMMAND;
    /**
    ...
    /* Change to  */
    void SetShowOption(int outputMode, int showOptParam);

    /* Set Data Get (output mode)*/
    void SetDataGet(int wait, int dataset);
    ...
    // - add
    void SetReflectorThreshold(uint8_t threshold);
...
//    unsigned int _socket;
   ...
   bool _validPulseFrequency( const unsigned int sick_motor_speed, const double sick_step_angle,
    ...
    std::string _Convert_HexStr_To_BinStr(int num); // std::string num);

    std::string _Convert_infoState_toBin(std::string num);
  };
