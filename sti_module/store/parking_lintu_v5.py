...
# update : 14/12/2020 : + check ke luc di vao 
#                       + TH ngoai line 
...
class StiAutomaticParking(threading.Thread):
    ...
    def run_ros(self, quangduong ):
        ...
        twist = Twist()
        if self.step_run_ros == 0 :
            odom_x_ht = self.odom_x
            odom_y_ht = self.odom_y
            self.step_run_ros = 1 

        if self.step_run_ros == 1 : 
    ...
    def run(self):
        ...
        #     if buoc == 31 :
        #         self.park_info(buoc,find_id,0,0,0)  
        #         if x_target > (self.kc_tag_robot_setup + 0.1) : # robot dung xa dau linetu 
        #             if self.run_ros(x_target - self.kc_tag_robot_setup) == 1 :
        #                 buoc = 32

        #         if x_target < (self.kc_tag_robot_setup - 0.1) : # robot dung qua gan\
        #             if self.run_ros(self.kc_tag_robot_setup - x_target ) == 1 :
        #                 buoc = 32
