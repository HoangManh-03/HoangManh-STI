...
class BroadcasterParking(threading.Thread):
    ...
    def sendTransform(self, frame_world, frame_id_pointTarget, point_target):
        ...
        euler = euler_from_quaternion((0.0, 0.0, point_target.orientation.z, point_target.orientation.w))
        # ----- fix
        angle_target = 0.
        if (euler[2] >= 0):
        ...
        self.tf_broadcaster.sendTransform((point_target.position.x, point_target.position.y, -1.),
                                        # (0.0, 0.0, point_target.orientation.z, point_target.orientation.w),
                                        (0.0, 0.0, quat[2], quat[3]),
