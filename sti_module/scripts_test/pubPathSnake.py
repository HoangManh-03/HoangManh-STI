...
def talker():
    ...
    path2.pointOne.position.y = 4.778
    path2.pointSecond = Pose()
    path2.pointSecond.position.x = 8.489
    path2.pointSecond.position.y = 5.778
    path2.velocity = 0.2
    path2.numberPts = 150
    path2.pointMid = Pose()
    ...
    # path3.pointSecond.position.x = 8.57
    ...
    path3.typePath = 3
    path3.pointOne = Pose()
    path3.pointOne.position.x = 8.489
    path3.pointOne.position.y = 5.778
    path3.pointSecond = Pose()
    path3.pointSecond.position.x = 7.57
    path3.pointSecond.position.y = 4.778
    path3.velocity = 0.2
    path3.numberPts = 150
    path3.pointMid = Pose()
    path3.pointMid.position.x = 7.57
    path3.pointMid.position.y = 5.778
    msg.pathInfo.append(path3)
