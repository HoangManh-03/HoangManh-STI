...
from message_pkg.msg import App_button
...
class CONTROL_PS3():
    def __init__(self):
        ...
        rospy.Subscriber('/app_button', App_button, self.callback_appButton)
        self.data_speed = 0
    ...
    def callback_appButton(self, data):
        self.data_speed = data.vs_speed
        self.cmd_linearMax = (self.data_speed/100.)*self.linear_max
        ...
        if self.safety or self.data_joy.buttons[BUTTONS_PS3.nhan.value]:
            ...
            if self.data_joy.axes[AXES_PS3.trai_len.value] > 0.5: # tien
                if self.direct_linear == 2 and self.curr_linear != 0.:
                    ...
                    self.cmd_linearNow = self.cmd_linearMax
